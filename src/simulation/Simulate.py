...
from simulation.functions import powerLawCutoff, powerLawKernel

class Simulate:
    def __init__(self):
        pass

    def createLOB(self, dictTimestamps, sizes, Pi_Q0, priceMid0 = 260, spread0 = 4, ticksize = 0.01, numOrdersPerLevel = 10, lob0 = {}, lob0_l3 = {}):
        lob = []
        lob_l3 = []
        T = []
    ...
    def thinningOgata(self, T, paramsPath, num_nodes = 12, maxJumps = None):
    ...
    def thinningOgataIS(self, T, paramsPath, todPath, num_nodes = 12, maxJumps = None, s = None, n = None, Ts = None, spread=None, beta = 0.7479, avgSpread = 0.0169,lamb= None):
        if maxJumps is None: maxJumps = np.inf
        tryer = 0
    ...
    def run(self, T, paramsPath, todPath, s0 = None, filePathName = None, Pis = None, Pi_Q0 = None, beta = 0.7479, avgSpread = 0.0169, spread0 = 3, price0 = 260, verbose = False):
        ...
        if s0 is None:
            ...
            s = s0
        Ts,lob,lobL3 = [],[],[]
        _, lob0, lob0_l3 = self.createLOB({}, {}, Pi_Q0, priceMid0 = price0, spread0 = spread0, ticksize = 0.01, numOrdersPerLevel = 5, lob0 = {}, lob0_l3 = {})
        Ts.append(0)
        lob.append(lob0[-1])
        ...
        lamb = None
        while s <= T:
            s, n, timestamps, timestamps_this, tau, lamb = self.thinningOgataIS(T, paramsPath, todPath, maxJumps = 1, s = s, n = n, Ts = timestamps, spread=spread, beta = beta, avgSpread = avgSpread, lamb = lamb)
            sizes = {}
            dictTimestamps = {}
